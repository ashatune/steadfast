        ...
        GlassCard {
            VStack(spacing: 16) {
                Text("Let’s personalize your experience")
                    .font(.title3).bold().foregroundColor(Theme.ink)

                VStack(spacing: 10) {
                    Text("What’s your name?")
                        .font(.callout).foregroundColor(Theme.inkSecondary)
            ...
            ScrollView {
                GlassCard {
                    VStack(alignment: .leading, spacing: 14) {
                        Text("Steadfast — Terms & Conditions").font(.title3).bold().foregroundColor(Theme.ink)
